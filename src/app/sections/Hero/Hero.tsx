  ...
  return (
    <>
      <div className='flex items-center mt-24 font-bold mx-auto justify-between mb-2'>
        <div className='text-secondary dark:text-white w-2/3 leading-none pr-20'>
          <h1 className='uppercase text-[55px]'>Alfredo Saavedra</h1>
          <h2 className='uppercase text-primary text-[36px]'>Fullstack Developer</h2>
          <p className='text-xl mt-10'>Desarrollador con más de 5 años de experiencia,
            ...
            aporto soluciones actualizadas y efectivas para mis clientes.</p>
        </div>
        <Image
          className='rounded-full w-96 h-96 object-cover items-center drop-shadow-light dark:drop-shadow-dark'
          src='/images/me.jpg'
